...
class _LoginMaskState extends State<LoginMask> {
  ...
  void _checkCanLogin() {
    setState(() {
      _canLogin =
          _username.isNotEmpty && _password.isNotEmpty && _abteilung.isNotEmpty;
    });
  }
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          Text(
            'Registrieren, kommt noch weg, nur für den Überblick noch hier',
        ...
        children: [
          ...
          Flexible(
            child: FractionallySizedBox(
              widthFactor: 1,
              child: Text(
                'Willkommen auf (Name der App). Hier kannst du deine Übungen von der Pfadi, sei es vom Sommerlager oder von einem Samstagnachmittag hochladen und mit anderen Pfadis teilen.',
        ...
        children: [
          ...
          Flexible(
            child: FractionallySizedBox(
              heightFactor: 1,
              child: Text(
                'Hallo, hier sollte nun ganzzzzzzzzzzzzzz viel platz sein zum schreibne, oder so hoofenjhtgjsadkjjfsdkjföa kasjdfklsd f ,asdfk jskdfjaikaöksldjföasf. ksdjfkdsjf ölsdflk',
                style: TextStyle(
                    fontSize: 15,
